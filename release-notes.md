...
* ⬆ Bump the github-actions group across 1 directory with 3 updates. PR [#438](https://github.com/tiangolo/uwsgi-nginx-flask-docker/pull/438) by [@dependabot[bot]](https://github.com/apps/dependabot).
* 👷 Migrate automatic labels to Latest Changes. PR [#436](https://github.com/tiangolo/uwsgi-nginx-flask-docker/pull/436) by [@tiangolo](https://github.com/tiangolo).
...
* ⬆️ Update latest-changes to 0.6.1. PR [#426](https://github.com/tiangolo/uwsgi-nginx-flask-docker/pull/426) by [@tiangolo](https://github.com/tiangolo).
